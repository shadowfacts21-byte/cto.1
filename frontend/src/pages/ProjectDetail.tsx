...
import { Briefcase, Loader2, ChevronLeft, Layout, List, Settings as SettingsIcon, Clock, BarChart3 } from 'lucide-react';
        ...
        <div className="flex justify-between items-center">
          ...
          <div className="flex bg-gray-100 p-1 rounded-lg">
            ...
            <button
              ...
              className={`flex items-center gap-2 px-3 py-1.5 rounded-md text-sm font-medium transition-all ${
                activeTab === 'time' ? 'bg-white text-indigo-600 shadow-sm' : 'text-gray-500 hover:text-gray-700'
              }`}
            >
              <Clock size={16} />
              Time
            ...
            <button
              ...
              className={`flex items-center gap-2 px-3 py-1.5 rounded-md text-sm font-medium transition-all ${
                activeTab === 'analytics' ? 'bg-white text-indigo-600 shadow-sm' : 'text-gray-500 hover:text-gray-700'
              }`}
            >
              <BarChart3 size={16} />
              Analytics
